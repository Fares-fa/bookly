...
- **Seed color:** `#0042D3` (used to derive `ColorScheme` via `ColorScheme.fromSeed` where applicable).
...
- **Poppins** — 10 file(s) configured in `pubspec.yaml` (app-wide `fontFamily` when primary)
- **Poppins LightItalic** — 1 file(s) configured in `pubspec.yaml`
- **Poppins MediumItalic** — 1 file(s) configured in `pubspec.yaml`
- **Poppins SemiBoldItalic** — 1 file(s) configured in `pubspec.yaml`
- **Poppins ThinItalic** — 1 file(s) configured in `pubspec.yaml`
- **Poppins BlackItalic** — 1 file(s) configured in `pubspec.yaml`
- **Poppins BoldItalic** — 1 file(s) configured in `pubspec.yaml`
- **Poppins ExtraBoldItalic** — 1 file(s) configured in `pubspec.yaml`
- **Poppins ExtraLightItalic** — 1 file(s) configured in `pubspec.yaml`
...
Import tokens via `package:bookly/src/theme/theme_constants.dart`.
