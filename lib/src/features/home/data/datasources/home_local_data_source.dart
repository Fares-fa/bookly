  ...
  Future<List<LiveScreening>> fetchLiveScreenings() async {
    ...
    return const [
      LiveScreening(
        ...
        imageAsset: 'assets/images/screenings/match_final.jpg',
        seatsLeft: 8,
      ),
      LiveScreening(
        id: 'screening-derby',
        title: 'Derby Night',
        imageAsset: 'assets/images/screenings/match_derby.jpg',
        seatsLeft: 5,
      ),
      LiveScreening(
        id: 'screening-classic',
        title: 'Classic Rivalry',
        imageAsset: 'assets/images/screenings/match_classic.jpg',
        seatsLeft: 8,
      ),
    ];
  }
